...
// PhotographyVideographyPage.jsx - FULLY FIXED
import React, { useRef, useState } from "react";
import { motion, useInView } from "framer-motion";

const PhotographyVideographyPage = () => {
  return (
    ...
    >
      {!imageError ? (
        ...
        <div className="w-full h-full flex flex-col items-center justify-center">
          ...
          <p className="text-white/50 text-sm">Your Visual Content</p>
...
// ============================================
// 🔥 HERO SECTION - Fixed with 3 Rings
// ============================================
const HeroSection = () => {
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            >
              Capture Your
              <br />
              <span className="text-[#FF6A3D]">Brand's Story</span>
              <br />
              In Every
              <br />
              <span className="text-[#FF6A3D]">Frame</span>
            </motion.h1>
            ...
            >
              Professional photography and videography services that bring your 
              brand to life with stunning visuals.
            </motion.p>
...
const ServicesOverview = () => {
  ...
  const services = [
    { icon: "📦", title: "Product Photography", description: "High-quality product images that showcase your products beautifully." },
    { icon: "🏢", title: "Corporate Photography", description: "Professional corporate imagery including headshots and team photos." },
    { icon: "🎉", title: "Event Photography", description: "Comprehensive event coverage for conferences and corporate events." },
    { icon: "🎬", title: "Brand Videos", description: "Compelling brand videos that tell your story effectively." },
    { icon: "📱", title: "Social Media Content", description: "Engaging visual content optimized for all social media platforms." },
    { icon: "🎥", title: "Commercial Ads", description: "High-impact commercial videos for TV and digital platforms." },
  ];
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#0B1C33] mb-4">
            Complete <span className="text-[#FF6A3D]">Visual Content</span> Solutions
          </h2>
        </motion.div>
...
const ProcessSection = () => {
  ...
  const steps = [
    { step: "01", icon: "💬", title: "Consultation", description: "We discuss your vision and project goals." },
    { step: "02", icon: "📋", title: "Pre-Production", description: "Mood boards, shot lists, and scheduling." },
    { step: "03", icon: "📸", title: "Production", description: "Professional shoot with our expert team." },
    { step: "04", icon: "✨", title: "Post-Production", description: "Expert editing and delivery." },
  ];
    ...
    <section ref={ref} className="bg-[#F8F9FA] py-20 sm:py-28 md:py-32">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#0B1C33] mb-4">
            How We <span className="text-[#FF6A3D]">Create</span> Magic
          </h2>
        </motion.div>
...
const EquipmentSection = () => {
  ...
  const equipment = [
    { icon: "📷", name: "Sony A7 Series", category: "Cameras" },
    { icon: "🎥", name: "Cinema Cameras", category: "Video" },
    { icon: "💡", name: "Professional Lighting", category: "Lighting" },
    { icon: "🎤", name: "Audio Equipment", category: "Sound" },
    { icon: "🖥️", name: "Editing Suites", category: "Post-Production" },
    { icon: "🚁", name: "Drone Coverage", category: "Aerial" },
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-white mb-6">
              Industry-Leading<br />
              <span className="text-[#FF6A3D]">Professional Gear</span>
            </h2>
            <p className="text-[#DFDFDF] text-lg mb-8 leading-relaxed">
              We invest in the best equipment to deliver exceptional quality.
            </p>
            <motion.button
              whileHover={{ scale: 1.03, boxShadow: "0 20px 40px rgba(255, 106, 61, 0.3)" }}
              whileTap={{ scale: 0.98 }}
          ...
          >
            {equipment.map((item, index) => (
              <motion.div
                ...
                className="bg-white/5 border border-white/10 rounded-xl p-4 text-center hover:border-[#FF6A3D]/30 transition-all duration-300"
              >
      ...
      <div className="max-w-4xl mx-auto px-6 sm:px-8 text-center">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-[#0B1C33] mb-6">
            Ready to Create<br />
            <span className="text-[#FF6A3D]">Stunning Visuals?</span>
          </h2>
          
          <p className="text-[#555555] text-lg mb-8 max-w-2xl mx-auto">
            Let's capture your brand's essence. Book a free consultation today.
          </p>
